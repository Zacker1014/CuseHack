...
class Game extends JFrame {
	...
	public class Time implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
            ...
            if ( circleY > y1Position &&circleY + CIRCLE_RADIUS < y1Position + 30 && (circleX == x1Position ||
                    circleX == x1Position + BLOCK_WIDTH)) {
                score--;
                fly = false;
                timer1.stop();
                timer.start();
            ...
            if (circleY > y2Position && circleY + CIRCLE_RADIUS < y2Position + 30 && (circleX == x2Position ||
                    circleX == x2Position + BLOCK_WIDTH)) {
                score--;
                fly = false;
                timer1.stop();
                timer.start();
            ...
            if (circleY > y3Position && circleY +CIRCLE_RADIUS < y3Position +30 && (circleX == x3Position ||
                    circleX == x3Position + BLOCK_WIDTH)) {
                score--;
                fly = false;
                timer1.stop();
                timer.start();
	...
	public class Draw extends JPanel {
		...
		public void paintComponent(Graphics g) {
            ...
            g.drawString("Score: " + String.valueOf(score), 820, 20);
